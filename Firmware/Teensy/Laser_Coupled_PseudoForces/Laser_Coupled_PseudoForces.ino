...
Mode currentMode = MODE_Debug;  // Initialize current mode to MODE_3
...
static uint16_t kNumberOfBins = 50; // CHANGED (From Above)
...
static uint32_t kSignalDurationUs = 25 * 1000; // in microseconds // CHANGED (From Above)
static float kSignalFrequencyHz = 40.f; // CHANGED (Removed constexpr)
